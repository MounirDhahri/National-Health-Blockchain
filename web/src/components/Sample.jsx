...
class Sample extends Component {
  ...
  submit = async (event)=>{
    ...
    if (responseData.success) {
      ...
      QRCode.toDataURL(this.state.doctorID+this.state.citizenID+this.state.price, { errorCorrectionLevel: 'H' }, function (err, url) {
        console.log(url);
        that.setState({
          img:url
        })
      ...
      <div className="App">
        ...
        <form>
          ...
          <div className="form-group">
            ...
            <input type="text" className="form-control" value={this.state.price} onChange={(price)=>{this.handleChangePrice(price)}}/>
          </div>
